# Generated by Django 3.2 on 2023-05-09 13:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(auto_now_add=True)),
                ('update_time', models.DateTimeField(auto_now=True)),
                ('test_server', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='testcase_run', to='testservers.testservers')),
            ],
        ),
        migrations.CreateModel(
            name='TestReports',
            fields=[
                ...
                ('create_time', models.DateTimeField(auto_now_add=True)),
                ('update_time', models.DateTimeField(auto_now=True)),
                ('component', models.ManyToManyField(default=None, related_name='testreports', to='testreports.ReportComponent')),
